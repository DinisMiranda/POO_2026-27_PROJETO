const NAV_MAIN = [
  ...
  },
  {
    ...
    label: "Exercicios",
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2a5 5 0 0 1 5 5v2a5 5 0 0 1-10 0V7a5 5 0 0 1 5-5z"/><path d="M2 20c0-3.3 2.7-6 6-6h8c3.3 0 6 2.7 6 6"/></svg>',
  },
  {
    key: "insights",
    href: "insights.html",
...
const NAV_BOTTOM = [
  {
    ...
    href: "settings.html",
    label: "Configuracoes",
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/><path d="M4.93 4.93a10 10 0 0 0 0 14.14"/></svg>',
  },
  {
    key: "ajuda",
    href: "ajuda.html",
