...
function fillUserInfo() {
 ...
 nameEl.textContent = user.name || `${user.firstName} ${user.lastName}`;
...
async function init() {
 ...
 try {
  ...
  streakEl.textContent = `Streak ${stats.streak || 0} dias`;
  checkinsEl.textContent = `${stats.totalCheckins || 0} check-ins`;
