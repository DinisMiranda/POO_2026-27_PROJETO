/**
 * Recomendacoes por regras fixas (humor 1-5 + periodo do dia).
 * Nao usa machine learning nem APIs externas.
 */
class RecommendationModel {
  ...
  getRecommendation(level, date = new Date()) {
    const period = this.getTimeOfDay(date);
